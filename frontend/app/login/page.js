...
export default function LoginPage() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#241811] px-5">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-md border border-[#C89B4A]/20 bg-[#F4EAD9] p-8 shadow-2xl">
        ...
        <h1 className="mt-2 text-2xl font-semibold text-[#241811]">Masuk</h1>
